...
public static class RazorConversor
{
    ...
    {
        string[] array = Directory.GetFiles(directory, "*.template", SearchOption.AllDirectories).Concat(
                         Directory.GetFiles(directory, "*.template", SearchOption.AllDirectories)).ToArray();
